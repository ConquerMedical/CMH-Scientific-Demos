...
const CFG={
  'abp':{name:'ABP · AI as a Biological Primitive',file:'ABP_session_report.html',anchor:'#c',results:['#modeResultTitle','#resultPanel','#contrastLine','#ground','#inverseSection','#bestRoute','#bestLevels','#rankedRoutes','#supportWhy'],labels:{surg:'Cytoreduction / resection level',rt:'Radiation',tz:'Agent intensity',wk:'Treatment week',abpEvidence:'Evidence substrate',inverseObjective:'Optimization objective'},displays:{surg:'vSurg',rt:'vRt',tz:'vTz',wk:'vWk'}},
